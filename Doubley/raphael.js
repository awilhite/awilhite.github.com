...
(function () {
    ...
    if (R.svg) {
        ...
        Element[proto].configTextPath = function (command, value1, value2) {
            if (this.removed || this.type!=="text") {
                return this;
            }
            this.node.childNodes[0][command](value1, value2);
            return this;
        };
        ...
        theTextPath = function (svg, path, text) {
            var el = $("text");
            $(el, {"text-anchor": "middle"});
            svg.canvas && svg.canvas[appendChild](el);
            var res = new Element(el, svg);
            var tpath = $("textPath");
            tpath.setAttributeNS("http://www.w3.org/1999/xlink", "href", path);
            tspan = $("tspan");
            tspan.setAttribute("dy", -10);
            tspan[appendChild](doc.createTextNode(text));
            tpath[appendChild](tspan);
            el[appendChild](tpath);
            res.attrs = {"text-anchor": "middle", font: availableAttrs.font, stroke: "none", fill: "#000"};
            res.type = "text";
            setFillAndStroke(res, res.attrs);
            return res;
        },
    ...
    paperproto.textPath = function (path, text) {
        return theTextPath(this, path, Str(text));
    };
